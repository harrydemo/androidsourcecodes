...
public class SDcardHistoryActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try{
			path = Utils.getFileRead(Contents.FILENAME);
	...
	private Button.OnClickListener goBackButton = new Button.OnClickListener() {
		...
		public void onClick(View v) {
			...
			Intent intent = new Intent(SDcardHistoryActivity.this, MainActivity.class);
			if(picPath != null) {
				bundle = new Bundle();
	...
	public void showMsg(int id) {
		Toast.makeText(SDcardHistoryActivity.this, id, Toast.LENGTH_SHORT).show();
	}
