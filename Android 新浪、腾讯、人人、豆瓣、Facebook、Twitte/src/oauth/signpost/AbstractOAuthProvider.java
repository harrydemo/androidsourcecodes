...
public abstract class AbstractOAuthProvider implements OAuthProvider {
	...
	public String retrieveRequestTokenForTencent(OAuthConsumer consumer,
			String callbackUrl) throws OAuthMessageSignerException,
			OAuthNotAuthorizedException, OAuthExpectationFailedException,
			OAuthCommunicationException {
		
        consumer.setTokenWithSecret(null, null);
        retrieveTokenForTencent(consumer, requestTokenEndpointUrl, OAuth.OAUTH_CALLBACK, callbackUrl);
	...
	public void retrieveAccessTokenForTencent(OAuthConsumer consumer, String oauthVerifier)
			throws OAuthMessageSignerException, OAuthNotAuthorizedException,
			OAuthExpectationFailedException, OAuthCommunicationException {
		...
		if (isOAuth10a && oauthVerifier != null) {
			retrieveTokenForTencent(consumer, accessTokenEndpointUrl,
    ...
    protected void retrieveTokenForTencent(OAuthConsumer consumer, String endpointUrl,
    		String... additionalParameters) throws OAuthMessageSignerException,
            OAuthCommunicationException, OAuthNotAuthorizedException,
            OAuthExpectationFailedException {
        Map<String, String> defaultHeaders = getRequestHeaders();
    ...
    protected abstract HttpRequest createRequestForTencent(String endpointUrl) throws Exception;
    ...
    protected abstract HttpResponse sendRequestForTencent(HttpRequest request) throws Exception;
