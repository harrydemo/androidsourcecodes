...
public class Weibo {
	...
	private static String APP_KEY = "2619768106";
	private static String APP_SECRET = "68f0f49dc7abd8788276680c7c96ae74";
	...
	public String getPublicTimeline(Context context,Paging paging) throws MalformedURLException,
		...
		String rlt = mWeibo.request(context, url, bundle, "GET", mWeibo
				.getAccessToken());
		return rlt;
	}
	
	public String updateStatus(Context context,String content) throws MalformedURLException,
	IOException, WeiboException {
		Weibo mWeibo = Weibo.getInstance();
		String url = Weibo.SERVER + "statuses/update.json";
		WeiboParameters bundle = new WeiboParameters();
		bundle.add("status",content);
		String rlt = mWeibo.request(context, url, bundle, "POST", mWeibo.getAccessToken());
		return rlt;
	}
	
	public String showStatus(Context context,String id) throws MalformedURLException,
	IOException, WeiboException {
		String rlt="";
		try{
		Weibo mWeibo = Weibo.getInstance();
		...
		WeiboParameters bundle = new WeiboParameters();
		bundle.add("id",id);
		 rlt= mWeibo.request(context, url, bundle, "GET", mWeibo.getAccessToken());
		}catch(Exception e){
			e.printStackTrace();
		}
		return rlt;
	...
	public String showUser(Context context,String id) throws MalformedURLException,
	IOException, WeiboException {
		String rlt="";
		try{
		Weibo mWeibo = Weibo.getInstance();
