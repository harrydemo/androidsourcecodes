 ...
 */
public class SelectCinema extends Activity
{
    private String[] provinces = {"浙江", "广东"};

    private String[][] cities = { {"杭州", "温州"}, {"广州", "珠海"}};

    private String[][] cinemas = { {"青春电影大世界", "西湖影院"}, {"大地影院", "珠海影院"}};
    ...
    private void init()
    {
        ...
        ArrayAdapter<String> areaAdapter = new ArrayAdapter<String>(context, android.R.layout.simple_spinner_item,
                provinces);
        ...
        proviceSpinner.setOnItemSelectedListener(new OnItemSelectedListener()
        {
            ...
            public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3)
            {
                ...
                ArrayAdapter<String> areaAdapter1 = new ArrayAdapter<String>(context,
                        android.R.layout.simple_spinner_item, cities[arg2]);
                ...
                citySpinner.setOnItemSelectedListener(new OnItemSelectedListener()
                {
                    ...
                    public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3)
                    {
                        ArrayAdapter<String> areaAdapter2 = new ArrayAdapter<String>(context,
                                android.R.layout.simple_spinner_item, cinemas[arg2]);
