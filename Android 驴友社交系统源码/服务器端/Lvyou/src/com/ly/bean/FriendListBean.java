...
public class FriendListBean {
	public String friendlist(InputStream in){
		...
		try {
			...
			ResultSet rs2 = (ResultSet) ((java.sql.Statement) st2).executeQuery(" select f.friend_id,f.u_id,u1.u_name,f.ue_id,u2.u_name from fxfriend_table f,fxuser_table u1,fxuser_table u2 where f.u_id=u2.u_id and u1.u_id=u2.u_id and f.ue_id="+id+"");
