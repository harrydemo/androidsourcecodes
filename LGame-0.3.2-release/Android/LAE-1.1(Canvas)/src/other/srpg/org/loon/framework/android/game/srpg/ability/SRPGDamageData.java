...
public class SRPGDamageData {
	...
	private final static LColor popColor = new LColor(192, 192, 0),
			numColor1 = new LColor(192, 192, 0), numColor2 = new LColor(0, 128,
					255), numColor3 = new LColor(0, 220, 0),
			numColor4 = new LColor(255, 128, 0), numColor5 = new LColor(192, 220,
					192);
