...
public class AVGChara implements LRelease {
	...
	public LTexture getCharacterCG() {
		return characterCG;
	}

	public void setCharacterCG(LTexture characterCG) {
