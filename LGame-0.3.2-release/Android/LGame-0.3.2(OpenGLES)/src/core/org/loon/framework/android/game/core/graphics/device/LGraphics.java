...
public final class LGraphics extends LGraphicsMath implements LTrans {
	...
	public void setColor(int r, int g, int b) {
		...
		paint.setColor(GLColor.getRGB(r, g, b));
	}
	...
	public void setColor(int pixels) {
		...
		paint.setColor(GLColor.getRGB(pixels));
	}
	...
	public void setColor(int r, int g, int b, int a) {
		...
		paint.setColor(GLColor.getARGB(r, g, b, a));
	}
	...
	public void setXORMode(LColor color) {
		...
		paint
				.setXfermode(new android.graphics.PixelXorXfermode(color
						.getRGB()));
	}
	...
	public void drawPixmap(LPixmap pix) {
		drawPixmap(pix, pix.getX(), pix.getY());
	}

	public void drawPixmap(LPixmap pix, int x, int y) {
		if (isClose) {
			return;
		}
		if (pix == null || pix.isClose()) {
			return;
		}
		canvas.drawBitmap(pix.getData(), 0, pix.getWidth(), x, y, pix
				.getWidth(), pix.getHeight(), pix.hasAlpha(), paint);
	}
