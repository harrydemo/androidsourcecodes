...
import org.loon.framework.android.game.core.graphics.opengl.LTexturePack;
...
public class SRPGFieldElements implements LRelease {
	...
	public void putBattleElement(int index, String name, String depict, int mv,
		...
		this.addBattleElement(index, (LImage) null, name, depict, mv, atk, def,
				state);
	}
	...
	public void addBattleElement(int index, String fileName, String name,
		...
		addBattleElement(index, new LImage(fileName), name, depict, mv, atk,
				def, state);
	}

	public void addBattleElement(int index, int mv, int state, LImage img,
			String name) {
		addBattleElement(index, img, name, "", mv, 100, 100, state);
	}

	public void addBattleElement(int index, LImage img, String name,
			String depict, int mv, int atk, int def, int state) {
		this.isRangeCheck(index);
		int id = -1;
		if (img != null) {
	...
	public LImage getBattleElementImage(int index) {
