...
public abstract class STGObject {
	...
	public STGObject(STGScreen stg, int no, int x, int y, int tpno) {
		this.plnNo = no;
		this.stg = stg;
		this.input = stg;
	...
	public void setPlaneGraphics(int imgId, int x, int y) {
	...
	public boolean contains(STGObject o) {
		...
		return contains(o.getX() + hitX, o.getY() + hitY, o.getHitW(), o
				.getHitH());
	}
