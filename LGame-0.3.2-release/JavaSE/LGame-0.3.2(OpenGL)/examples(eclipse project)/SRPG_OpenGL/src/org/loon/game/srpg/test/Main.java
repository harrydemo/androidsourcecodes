package org.loon.game.srpg.test;
...
import org.loon.framework.javase.game.srpg.actor.SRPGActorStatus;
 ...
 * @version 0.1
 */
public class Main extends SRPGScreen {
	...
	protected void initFieldElementConfig(SRPGFieldElements elements) {
		...
		/*elements.addBattleElement(0, ELEMENT_PALACE,"assets/floor.gif", "皇宫");
		elements.addBattleElement(1, ELEMENT_WALL,"assets/wall.gif", "雕塑");*/
	}
	...
	public static void main(String[] args) {
		GameScene frame = new GameScene("SRPG_OpenGL_TEST", 480, 320);
		frame.setShowFPS(true);
		// frame.setShowMemory(true);
