...
import org.loon.framework.javase.game.action.sprite.effect.FreedomEffect;
import org.loon.framework.javase.game.action.sprite.effect.PetalKernel;
import org.loon.framework.javase.game.action.sprite.effect.RainKernel;
import org.loon.framework.javase.game.action.sprite.effect.SnowKernel;
import org.loon.framework.javase.game.core.LSystem;
import org.loon.framework.javase.game.core.graphics.Desktop;
		...
		if (sleep == 0) {
			...
			try {
				if (scrCG.getBackgroundCG() != null) {
					if (shakeNumber > 0) {
						g.drawTexture(scrCG.getBackgroundCG(), shakeNumber / 2
