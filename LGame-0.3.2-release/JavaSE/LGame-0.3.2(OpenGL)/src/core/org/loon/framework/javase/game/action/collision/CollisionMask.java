...
import org.loon.framework.javase.game.core.geom.Point;
...
public class CollisionMask implements LRelease {
	...
	public static Mask createMask(String res) {
		return createMask(LImage.createImage(res));
	}

	public static Mask createMask(LImage image) {
		if (image == null) {
			throw new RuntimeException("Image is null !");
		}
	...
	public static Mask createMask(int[] pixels, int w, int h) {
		int width = w;
		int height = h;
