...
import org.loon.framework.javase.game.core.geom.Path;
...
public class Cycle extends LObject implements ISprite {
		...
		case 0:
			cycle = new Cycle() {
				...
				public void step(GLEx g, float x, float y, float progress,
						int index, int frame, GLColor color, float alpha) {
	...
	protected float alpha, scaleX, scaleY;
	...
	public void step(GLEx g, float x, float y, float progress, int index,
			int frame, GLColor color, float alpha) {
