...
import org.loon.framework.javase.game.core.graphics.LPixmapData;
	...
	public void setImage(LImage image, float limit) {
		...
		for (int y = 0; y < height; y++) {
			for (int x = 0; x < width; x++) {
				...
				fractions[n].x = x;
				fractions[n].y = y;
				fractions[n].vx = MathUtils.cos(angle * MathUtils.PI / 180)
						* speed;
				fractions[n].vy = MathUtils.sin(angle * MathUtils.PI / 180)
						* speed;
