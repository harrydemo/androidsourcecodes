...
public class CSVTable {
	 ...
	 * @return
	 */
	final static public Object[] load(final String fileName, final Class clazz) {
		Object[] obj = null;
		try {
				...
				for (int i = 0; i < size; i++) {
					...
					if (property != null) {
						...
						for (Iterator it = set.iterator(); it.hasNext();) {
							...
							register(obj[i], (String) entry.getKey(),
	 ...
	 * @return
	 */
	final static private Object[] bind(final Class clazz,
