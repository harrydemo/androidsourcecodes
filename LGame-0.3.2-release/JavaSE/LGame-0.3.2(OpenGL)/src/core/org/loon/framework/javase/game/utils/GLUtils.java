...
import org.loon.framework.javase.game.core.graphics.opengl.GL11;
...
public class GLUtils {
	...
	public static void vertexPointer(GL10 gl10,int size, FloatBuffer buffer) {
		gl10.glVertexPointer(size, GL10.GL_FLOAT, 0, buffer);
	}
	...
	public static void setClearColor(final GL10 gl10, GLColor c) {
	...
	public static void bindTexture(final GL10 gl10, final int hardwareTextureID) {
		try {
			if (GLUtils.currentHardwareTextureID != hardwareTextureID) {
				...
				gl10.glBindTexture(GL10.GL_TEXTURE_2D, hardwareTextureID);
			}
		} catch (Exception e) {
		}
	}
