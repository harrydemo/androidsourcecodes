...
import org.loon.framework.javase.game.srpg.effect.SRPGPopupEffect;
import org.loon.framework.javase.game.srpg.field.SRPGMoveStack;
...
public class SRPGDamageData {
	...
	private final static GLColor popColor = new GLColor(0.75f, 0.75f, 0),
			numColor1 = new GLColor(0.75f, 0.75f, 0), numColor2 = new GLColor(0, 0.5f,
					1f), numColor3 = new GLColor(0, 0.86f, 0),
			numColor4 = new GLColor(1f, 0.5f, 0), numColor5 = new GLColor(0.75f, 0.86f,
					0.75f);
