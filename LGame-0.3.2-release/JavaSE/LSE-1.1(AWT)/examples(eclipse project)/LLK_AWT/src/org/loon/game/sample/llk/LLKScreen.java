...
public class LLKScreen extends Screen {
	...
	public void onLoad() {
		...
		for (int i = 0; i < 8; i++) {
			images[i] = new LImage("assets/" + i + ".jpg");
		}

		final String res = "assets/res.lpk";

		images[8] = LPKResource.openLImage(res, "a0.png");
		images[9] = LPKResource.openLImage(res, "dot.png");
		images[10] = LPKResource.openLImage(res, "background.jpg");
		images[11] = LPKResource.openLImage(res, "role0.png");
		images[12] = LPKResource.openLImage(res, "role1.png");
		images[13] = LPKResource.openLImage(res, "role2.png");
		images[14] = LPKResource.openLImage(res, "win.png");
		images[15] = LPKResource.openLImage(res, "start.png");
		images[16] = LPKResource.openLImage(res, "gameover.png");
