...
public class Main extends SRPGScreen {
	...
	protected void initActorConfig(SRPGActors actors) {
		...
		// 设定脸谱(没有也无所谓)
		p.getActorStatus().face = new LImage("assets/cpf.png");
		// 身份为敌方主角
		...
		hero.getActorStatus().face = new LImage("assets/rzf.png");

		hero1 = actors.putActor(2, "鱿鱼娘", "assets/wz.png", 17, 95, 0, 7, 3);
		hero1.setDirection(MOVE_RIGHT);
		hero1.getActorStatus().face = new LImage("assets/wzf.png");
	...
	protected boolean processDeadActor(int index) {
		...
		if (index != 0) {
			...
			if (oldStatus.level < 99) {
				...
				LImage old = actor.getActorStatus().face;
				// 重新设定状态
	...
	public static void main(String[] args) {
		GameScene scene = new GameScene("SRPG_AWT_TEST", 480, 320);
