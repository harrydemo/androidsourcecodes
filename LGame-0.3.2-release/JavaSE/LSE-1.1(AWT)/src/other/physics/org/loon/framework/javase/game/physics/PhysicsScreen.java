...
public abstract class PhysicsScreen extends Screen implements ContactListener,
	...
	public PhysicsScreen(Vector2 gravity, boolean doSleep,
		...
		this.running = true;
		this.physicsFPS = LSystem.DEFAULT_MAX_FPS / 5;
	...
	public PhysicsObject bindTo(BufferedImage bitmap, Body body) {
		synchronized (objects) {
	...
	public PhysicsObject bindTo(BufferedImage img, int poly, BodyType type,
			int x, int y) {
		synchronized (objects) {
			PhysicsObject o = new PhysicsObject(img, poly, type, x, y);
			addObject(o);
	...
	public PhysicsObject bindTo(BufferedImage img, BodyType type, int x, int y) {
		synchronized (objects) {
			PhysicsObject o = new PhysicsObject(img, type, x, y);
			addObject(o);
			return o;
	...
	final public void mouseDown(final MouseEvent e) {
	...
	public abstract void onDown(MouseEvent e);

	final public void mouseMove(final MouseEvent e) {
		onMove(e);
		return;
	}
	...
	public abstract void onUp(MouseEvent e);
