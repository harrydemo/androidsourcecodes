...
public class SRPGOUTEffect extends SRPGEffect {
	...
	public SRPGOUTEffect(int x, int y, Color color) {
		this.t_x = x;
		this.t_y = y;
		this.color = color;
		...
		this.de[4] = new SRPGDelta(res, 1.3999999999999999D, 1.3999999999999999D,
				36D);
		this.de[5] = new SRPGDelta(res, -1.3999999999999999D, 1.3999999999999999D,
				36D);
		this.de[6] = new SRPGDelta(res, 1.3999999999999999D, -1.3999999999999999D,
				36D);
		this.de[7] = new SRPGDelta(res, -1.3999999999999999D, -1.3999999999999999D,
				36D);
		this.setExist(true);
	}
