...
public class KnowledgeAddOrModify extends BaseActivity {
	...
	protected void initialComponent(BaseActivity context) {
		...
		tvknowledge=(TextView) this.findViewById(R.id.directorymanager);
		tvknowledge.setText("知识");
	}
	@Override
	protected void initialSetup(BaseActivity context) {
		...
		if(addOrmodify.equals(Config.ADD)){
		     ...
		     view4=new TextViewEdit(this, "知识名称","",dm);
		     view5=new TextViewEdit(this, "知识类型","",dm);
		    ...
		    view4=new TextViewEdit(this, "知识名称",listdata.get(3),dm);
		    view5=new TextViewEdit(this, "知识类型",listdata.get(4),dm);
			...
			submit.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if(addOrmodify.equals("add")){
						dialogShow(KnowledgeAddOrModify.this,"添加","确定添加吗?");
					}else if(addOrmodify.equals("modify")){
						dialogShow(KnowledgeAddOrModify.this,"修改","确定修改吗?");
					}else{
