...
public class SSLSocketFactory implements LayeredSocketFactory {
     ...
     */
    public static SSLSocketFactory getSocketFactory(String proxyhost, int proxyport) {
    	if (DEFAULT_FACTORY == null) {
    		DEFAULT_FACTORY = new SSLSocketFactory(proxyhost, proxyport);
    	}
     ...
     */
    private SSLSocketFactory(String host, int port) {
        super();
        this.sslcontext = null;
