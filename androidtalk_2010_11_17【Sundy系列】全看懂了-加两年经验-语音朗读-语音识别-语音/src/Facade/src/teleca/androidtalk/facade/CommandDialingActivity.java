/**
 * @description : Activity of identify dialing command .
 * @version 1.0
 * @author Alex
 * @date 2010-11-10
 */
...
public class CommandDialingActivity extends Activity implements OnClickListener
{
	...
	public void onCreate(Bundle icicle) 
	{
		...
		edit3.setSaveEnabled(true);
		//set edit3 can only accept numbers.
		edit3.setKeyListener(new NumberKeyListener()
		{
			@Override
	...
	public void onClick(View v) 
	{
		...
		if(v == btn_save)
		{
			...
			boolean flag = Helper.isNameExist(cmd_name,CommandDialingActivity.this);
			...
			if (!(cmd_name.equals(""))&& !(cmd_relation.equals(""))) 
			{
				if (!flag) 
				{
					Helper.addCommand(CommandDialingActivity.this, cmd_name, cmd_category, cmd_relation);
					Intent i = new Intent();
