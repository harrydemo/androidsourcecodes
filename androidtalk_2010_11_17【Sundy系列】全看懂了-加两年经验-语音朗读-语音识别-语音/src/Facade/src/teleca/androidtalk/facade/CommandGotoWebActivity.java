/**
 * @description : Activity of identify GotoWeb command .
 * @version 1.0
 * @author Alex
 * @date 2010-11-10
 */
...
public class CommandGotoWebActivity extends Activity implements OnClickListener
{
	...
	public void onClick(View v) 
	{
		...
		if(v == btn_save)
		{
			...
			boolean flag = Helper.isNameExist(cmd_name,CommandGotoWebActivity.this);
			...
			if (!(cmd_name.equals(""))&& !(cmd_relation.equals(""))) 
			{
				if (!flag) 
				{
					Helper.addCommand(CommandGotoWebActivity.this, cmd_name, cmd_category, cmd_relation);
					Intent i = new Intent();
