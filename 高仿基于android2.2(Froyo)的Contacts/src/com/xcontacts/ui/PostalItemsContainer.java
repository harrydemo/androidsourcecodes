...
public class PostalItemsContainer extends AbstractItemsContainer {

	public PostalItemsContainer(Context context) {
		super(context);
	}
	...
	public ArrayList<ContentProviderOperation> getItemsContentProviderOperation() {
		...
		if (count > 0) {
			...
			for (int i = 0; i < count; i++) {
				PostalItem item = (PostalItem) mItemsContainer.getChildAt(i);
	...
	public void addItem(int typesRes, int hintArrayRes) {
		PostalItem item = new PostalItem(mContext);
